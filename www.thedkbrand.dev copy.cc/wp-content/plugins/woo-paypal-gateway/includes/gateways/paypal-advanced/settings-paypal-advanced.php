...
return $this->form_fields = array(
    'enabled' => array(
        ...
        'label' => __('Enable PayPal Pro Advanced Edition', 'woo-paypal-gateway'),
        'type' => 'checkbox',
        'description' => '',
        'default' => 'no'
    ),
    ...
    'debug' => array(
        ...
        'default' => 'no',
        'desc_tip' => true,
        'description' => __('Log PayPal Pro (Advanced) events inside <code>woocommerce/logs/paypal-pro-advanced.txt</code>', 'woo-paypal-gateway'),
    )
);
