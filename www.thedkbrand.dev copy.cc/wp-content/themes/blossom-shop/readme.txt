...
Blossom Shop WordPress Theme, Copyright 2017 blossomthemes.com
Blossom Shop is distributed under the terms of the GNU GPL
...
Blossom Shop bundles the following third-party resources:
...
Blossom Shop Theme incorporates code from Kirki, Copyright (c) 2017 Aristeides Stathopoulos
...
Banner Image 		
Source  : https://pxhere.com/en/photo/112362
License : CC0 Public Domain, https://pxhere.com/en/license

404 page Image 
Source  : https://stocksnap.io/photo/PHOFG380TU
...
== Changelog ==
    ...
    1.0.7 - April 30, 2020
        ...
        * Fixed: Menu focus issue while last item has submenu
        * Fixed: Page header spacing issue
        * Fixed: Translation issue
        * Added: Overlay in page header
        * Added: Feature to upload page header background image
        * Changed: Text color in page header
    ...
    1.0.5 - April 17, 2020
        ...
        * Fixed: Other issues listed from theme reviewer 

    1.0.4 - April 7, 2020
        * Fixed: Issues listed from theme reviewer

    1.0.3 - March 18, 2020
        * Added: Owl Carousel v2 Accessibility Layer js
        * Fixed: instagram section design issue
        * Improved: adding inline style

	1.0.2 - January 13, 2020
        * Fixed: Typo error
        * Fixed: Edge hover issue
        * Changed: Getting Started support description
            
    1.0.1 - October 22, 2019
        * Fixed: Breadcrumb Error
        * Fixed: Multiple woocommerce category desc
        * Tweaked: Updated Google Fonts library
