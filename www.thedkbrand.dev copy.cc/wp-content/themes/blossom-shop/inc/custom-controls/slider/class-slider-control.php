<?php
/**
 * Blossom Shop Customizer Slider Control.
 * 
...
if ( ! class_exists( 'Blossom_Shop_Slider_Control' ) ){
	/**
	 * Slider control (range).
    */
	class Blossom_Shop_Slider_Control extends WP_Customize_Control {
        ...
        public function enqueue() {            
            wp_enqueue_style( 'blossom-shop-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.css', null );
            wp_enqueue_script( 'blossom-shop-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.js', array( 'jquery' ), false, true ); //for slider                
        }
