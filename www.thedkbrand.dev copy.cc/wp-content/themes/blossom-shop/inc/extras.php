	...
	<?php endif; ?>
        ...
        <footer class="comment-meta">
            <div class="comment-author vcard">
               ...
               <?php printf( __( '<b class="fn" itemprop="creator" itemscope itemtype="http://schema.org/Person">%s</b> <span class="says">says:</span>', 'blossom-shop' ), get_comment_author_link() ); ?>
